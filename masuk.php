...
<body class="landing-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('login/img/beras.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1 class="title">Sistem Penjualan Beras</h1>
          <h4>Silahkan Login </h4>
          <br>          
         
          <a href="login_aksi.php" class="btn btn-success btn-raised btn-lg">
