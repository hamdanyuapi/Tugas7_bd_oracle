          ...
          <div class="box">
            <div class="box-header">
             ...
             <div class='panel-body'>
                <a class='btn btn-primary' href='add_kelapa.php'><i class='fa fa-plus'></i> Tambah Data</a>
                <a class="btn btn-danger" href="cetak.php" ><i class="fa fa-print"></i> Export xls</a>
